namespace AerolineasParcial.CRUD.Altas
{
    partial class FormAltaViaje
    {
        ...
        protected ComboBox cBoxDestinos;
        protected TextBox tBoxPartida;
        protected DateTimePicker dateTimePicker;
        protected Button btnAsignarAeronave;
        protected CheckBox chbxInternacional;
        protected TextBox tBoxAeronave;
        protected TextBox tBoxDuracion;
        protected Label lblCantTurista;
        protected Label lblCantPremium;
        protected Label lblPrecioTurista;
        protected Label lblPrecioPremium;
    }
}